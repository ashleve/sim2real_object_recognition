...
namespace UnityEngine.Experimental.Perception.Randomization.Randomizers.SampleRandomizers
{
    ...
    /// </summary>
    [Serializable]
    [AddRandomizerMenu("Perception/My Foreground Randomizer")]
    public class MyForegroundRandomizer : Randomizer
    {
        ...
        /// </summary>
        public FloatParameter depthRange;
        ...
        protected override void OnIterationStart()
        {
            ...
            foreach (var sample in placementSamples)
            {
                ...
                instance.transform.position = new Vector3(sample.x, sample.y, depthRange.Sample()) + offset;
